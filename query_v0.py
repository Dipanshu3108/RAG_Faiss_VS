...
def main():
    ...
    - If only word exists then straight up provide the explanation
    - If the same words have multiple meaning. look for top 5. if there are less than 5 then look for all the definition which will be [words and definitions] <= 4
    ...
    - If the context doesn't contain relevant information, just say "I couldn't find a definition for that in my database." and proivde the top 5 smilar words and their respctive definition.
